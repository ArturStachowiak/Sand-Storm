...
WIND_STRENGTH = 3.0  # Zwiększona siła wiatru
...
class Wind:
    def __init__(self):
        ...
        self.turbulence = 0.3  # Zwiększona turbulencja
    ...
    def update(self):
        ...
        # Update wind strength - zwiększona siła
        self.strength = WIND_STRENGTH + math.sin(current_time) * 0.8  # Zwiększona wariacja
        
        self.last_update = current_time
        
    def get_force(self, position, particle_size):
        # Wind gets stronger with height
        height_factor = 1.0 + position[1] * 0.2  # Zwiększony wpływ wysokości
        
        # Add some local turbulence based on position
        turbulence = np.array([
            math.sin(position[0] * 0.5) * 0.2,  # Zwiększona turbulencja
            math.cos(position[1] * 0.5) * 0.1,
            math.sin(position[2] * 0.5) * 0.2
        ])
...
class Particle:
    ...
    def update(self, wind):
        ...
        # Add some random turbulence (more for smaller particles) - zwiększona turbulencja
