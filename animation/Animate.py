...
cube.add_component(Cube(GL_POLYGON, "/home/lab/Downloads/impl/images/wall.tif"))
...
cube2.add_component(Cube(GL_POLYGON, "/home/lab/Downloads/impl/images/brick.tif"))
...
def set_2d():
    ...
    glLoadIdentity()  # Resteowanie macierzy modelu widoku
