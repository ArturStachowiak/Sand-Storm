...
from rendering.DisplayNormals import *
from pygame.locals import *
from OpenGL.GLU import *
from utils.LoadMesh import *
...
pygame.display.set_caption('OpenGL w Pythonie')
...
cube.add_component(Cube(GL_POLYGON, "/home/lab/Downloads/impl/images/brick.png"))

mesh = Object("Plane")
mesh.add_component(Transform((-1.5, 0, -3.5)))
mesh.add_component(LoadMesh(GL_TRIANGLES, "/home/lab/Downloads/impl/models/plane2.obj", back_face_cull=True))

leaf = Object("Leaf")
leaf.add_component(Transform((0, 0, -3)))
leaf.add_component(LoadMesh(GL_TRIANGLES, "/home/lab/Downloads/impl/models/cube.obj"))
...
def set_2d():
    ...
    glLoadIdentity()  # Resetowanie macierzy widoku modelu.
